...
- 2026-07-07: Automation sequences + reply-aware stops (plan 008) — welcome (2-step), no-response (3-step: 0/+24h/+48h), trial ladder (confirm + −24h/−1h/−5min), post-trial follow-up moved to +1h; follow-up steps cancel at dispatch on an inbound WhatsApp reply or lead progress (`hasRepliedSince` guard); additive (new seeded rules/templates + offset sync), no schema change
